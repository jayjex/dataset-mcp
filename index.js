...
const server = new McpServer(
  { name: "dataset-mcp", version: VERSION },
  {
    instructions:
      ...
      "Examples: query_dataset(\"hud-fmr-2026\", { where: [{column: \"state\", op: \"=\", value: \"TX\"}], limit: 5 }); query_dataset(\"nfl-games\", { where: [{column: \"season\", op: \"=\", value: 2025}], limit: 10 }); get_stats(\"airbnb-six-cities\", { file: \"airbnb-new-york-city.csv\", column: \"price\" }).",
  }
);
...
server.tool(
  ...
  {
    slug: z.string().describe("Queryable dataset slug, e.g. \"hud-fmr-2026\", \"nfl-games\", \"airbnb-six-cities\", \"earn-bounties\""),
    file: z
      .string()
      .optional()
